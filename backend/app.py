...
<head>
    ...
    <title>BuyTheDip API Status</title>
...
<body>
    <div class="card">
        <div class="logo">Buy<span>TheDip</span> API</div>
        <div class="status-badge">
            <span class="status-dot"></span>
            Operational &amp; Healthy
        </div>
        <h1>API Server Online</h1>
        <p>This is the production backend services gateway for the BuyTheDip Stock and Crypto Scanner.</p>
        
        <div class="endpoints-list">
            <div class="endpoints-title">Available Gateways</div>
            <div class="endpoint-item">
                <span class="endpoint-path">/scan</span>
                <span class="endpoint-method">POST</span>
            </div>
            <div class="endpoint-item">
                <span class="endpoint-path">/stock-universe/&lt;type&gt;</span>
        ...
        <a href="https://buythedip.darshanrajashekar.dev" class="btn" target="_blank">Launch Scanner App</a>
    </div>
</body>
</html>"""
